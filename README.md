...
- Non-Overlapping Mode: Resets to initial state after detection, requiring complete restart✅ Dual Moore FSM Variants: Separate implementations for overlapping/non-overlapping
